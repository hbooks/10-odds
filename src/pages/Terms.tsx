...
// ─── Page ─────────────────────────────────────────────────────────────────────
const TermsPage = () => {
  const lastUpdated = "15 May 2026"; // change DATE HERE when updating the TOS
        ...
        <div className="space-y-8">
          <Section index={1} number="01" title="Introduction">
            ...
            <p>
              ...
              predictions and accumulator slips. We also operate{" "}
          ...
          <Section index={4} number="04" title="AI‑Generated Content">
            <p>
              Predictions produced by <strong className="text-foreground">MK-806</strong> and{" "}
          ...
          <Section index={8} number="08" title="Intellectual Property">
            <p>
              All content on the Site — including but not limited to text, graphics,
              prediction data, algorithm outputs, the MK-806 and Hippo AI brands, and
          ...
          <Section index={9} number="09" title="Third‑Party Services">
            <p>
            ...
            <ul className="list-disc list-inside space-y-1.5 pl-2">
              ...
              <li>
                ...
                hosting, authentication, and edge functions.
              </li>
            </ul>
            <p>
          ...
          <Section index={10} number="10" title="Limitation of Liability">
            <p>
            ...
            <ul className="list-disc list-inside space-y-1.5 pl-2">
              ...
              <li>Any reliance on predictions, analysis, or alternative market suggestions.</li>
              <li>Financial losses incurred from betting decisions.</li>
              <li>Errors, inaccuracies, or interruptions in the Site's operation.</li>
              <li>Downtime or failures of third‑party APIs (BSD, Groq, Supabase).</li>
            </ul>
            <p>
          ...
          <Section index={11} number="11" title="Changes to Terms">
            <p>
          ...
          <Section index={12} number="12" title="Contact Information">
            <p>
