    ...
    <Layout>
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-8">
          ...
          {/* ─── NEW SECTION: Account Deletion ────────────────────────────── */}
          <Section index={13} number="13" title="Account Deletion">
            <p>
              You may request the deletion of your account and all associated personal
              data at any time. To initiate this process, please navigate to your{" "}
              <strong className="text-foreground">Profile Settings</strong> page within
              the Site and submit a deletion request.
            </p>
            <p>
              Upon receipt of your request, our team will:
            </p>
            <ul className="list-disc list-inside space-y-1.5 pl-2">
              <li>
                <strong className="text-foreground">Verify your identity</strong> to
                ensure the request is legitimate and authorised.
              </li>
              <li>
                <strong className="text-foreground">Review your account status</strong>{" "}
                to confirm there are no outstanding obligations, unresolved issues, or
                pending matters associated with your account.
              </li>
              <li>
                <strong className="text-foreground">Initiate the deletion process</strong>,
                which permanently removes your personal data from our active systems
                and databases.
              </li>
            </ul>
            <p>
              Please allow <strong className="text-foreground">1–3 business days</strong>{" "}
              for the review and processing of your request. You will receive a
              confirmation email once your data has been successfully deleted and your
              account has been permanently removed from our systems.
            </p>
            <div className="bg-muted/40 rounded-lg p-4 space-y-2 mt-3">
              ...
              <ul className="list-disc list-inside space-y-1 pl-2 text-muted-foreground">
                <li>
                  Account deletion is <strong className="text-foreground">irreversible</strong>.
                  Once processed, all associated data — including your email address,
                  username, profile crest, and any submitted content — will be permanently
                  removed and cannot be recovered.
                </li>
                <li>
                  We may retain certain <strong className="text-foreground">anonymised</strong>{" "}
                  or <strong className="text-foreground">aggregated</strong> data for
                  analytical or statistical purposes, provided it no longer identifies
                  you personally.
                </li>
                <li>
                  We may also retain data if required by applicable law, regulation, or
                  legal proceedings, including but not limited to fraud prevention,
                  dispute resolution, and compliance with regulatory obligations.
                </li>
              </ul>
            </div>
            <p>
              If you have any questions regarding the account deletion process, please
              contact us at <span className="text-gold">legal@hpbooks.uk</span> and we
              will be happy to assist you.
            </p>
          </Section>

          <Section index={14} number="14" title="Contact Information">
            <p>
